 ...
 */
class UserAccount extends ComponentBase
{
    public function componentDetails()
    {
        return [
            'name'        => /*Account*/
                'horizonstack.userextend::lang.extend_account.account',
            'description' => /*User management form.*/
                'horizonstack.userextend::lang.extend_account.account_desc',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'redirect'    => [
                'title'       => /*Redirect to*/
                    'horizonstack.userextend::lang.extend_account.redirect_to',
                'description' => /*Page name to redirect to after update, sign in or registration.*/
                    'horizonstack.userextend::lang.extend_account.redirect_to_desc',
                'type'        => 'dropdown',
                'default'     => '',
            ],
            'paramCode'   => [
                'title'       => /*Activation Code Param*/
                    'horizonstack.userextend::lang.extend_account.code_param',
                'description' => /*The page URL parameter used for the registration activation code*/
                    'horizonstack.userextend::lang.extend_account.code_param_desc',
                'type'        => 'string',
                'default'     => 'code',
            ],
            'forceSecure' => [
                'title'       => /*Force secure protocol*/
                    'horizonstack.userextend::lang.extend_account.force_secure',
                'description' => /*Always redirect the URL with the HTTPS schema.*/
                    'horizonstack.userextend::lang.extend_account.force_secure_desc',
                'type'        => 'checkbox',
                'default'     => 0,
            ],
        ];
    ...
    public function loginAttributeLabel()
    {
        return Lang::get($this->loginAttribute() == UserSettings::LOGIN_EMAIL
            ? /*Email*/
            'rainlab.user::lang.login.attribute_email'
            : /*Username*/
            'rainlab.user::lang.login.attribute_username'
        );
    }
    ...
    public function onSignin()
    {
        try {
            ...
            $messages = [
                'login.email' => 'Masukan alamat email yang valid.',
            ];
            ...
            if ($user->isBanned()) {
                Auth::logout();
                throw new AuthException(/*Sorry, this user is currently not activated. Please contact us for further assistance.*/
                    'rainlab.user::lang.account.banned');
            }
    ...
    public function onRegister()
    {
        try {
            if ( ! $this->canRegister()) {
                throw new ApplicationException(Lang::get(/*Registrations are currently disabled.*/
                    'rainlab.user::lang.account.registration_disabled'));
            }
    ...
    public function onActivate($code = null)
    {
        try {
            ...
            $errorFields = [
                'code' => Lang::get(/*Invalid activation code supplied.*/
    ...
    public function onUpdate()
    {
        ...
        Flash::success(post('flash', Lang::get(/*Settings successfully saved!*/
            'rainlab.user::lang.account.success_saved')));
    ...
    public function onDeactivate()
    {
        ...
        Flash::success(post('flash', Lang::get(/*Successfully deactivated your account. Sorry to see you go!*/
            'rainlab.user::lang.account.success_deactivation')));
    ...
    public function onSendActivationEmail()
    {
        try {
            if ( ! $user = $this->user()) {
                throw new ApplicationException(Lang::get(/*You must be logged in first!*/
                    'rainlab.user::lang.account.login_first'));
            }

            if ($user->is_activated) {
                throw new ApplicationException(Lang::get(/*Your account is already activated!*/
                    'rainlab.user::lang.account.already_active'));
            }
