<?php namespace Horizonstack\Investment\FormWidgets;
 ...
 *           zip: zip
 */
class InvestmentAddressFinder extends FormWidgetBase
{
    /**
     * {@inheritDoc}
     */
    public $defaultAlias = 'investmentaddressfinder';
    ...
    public function render()
    {
        ...
        return $this->makePartial('investment_addressfinder');
    }
